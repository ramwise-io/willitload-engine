...
All scenarios in this report can be run locally using the test data and datasets included in this repository:

* **Scenarios 1–5**: These are based on the synthetic test fixture files generated under `tests/fixtures/`. You can regenerate them at any time by running:
  ```bash
